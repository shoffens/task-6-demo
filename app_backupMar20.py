    ...
    return [
        ...
        'layout': {
            ...
            'shapes': [
                ...
                # {'visible':centerball, 'type': 'circle', 'xref': 'x', 'yref': 'y', 'x0': one_ball_center_x-bdia/2, 'y0': one_ball_center_y-bdia/2, 'x1': one_ball_center_x+bdia/2, 'y1': one_ball_center_y+bdia/2, 'fillcolor': 'white', 'line': dict(color="crimson", width=1)},
                ...
                # {'type': 'circle', 'xref': 'x', 'yref': 'y', 'x0': one_ball_center_x-bdia/2, 'y0': one_ball_center_y-bdia/2, 'x1': one_ball_center_x+bdia/2, 'y1': one_ball_center_y+bdia/2, 'fillcolor': 'white', 'line': dict(color="crimson", width=1)},
                # [{'type': 'circle', 'xref': 'x', 'yref': 'y', 'x0': one_ball_center_x-bdia/2+k, 'y0': one_ball_center_y-bdia/2, 'x1': one_ball_center_x+bdia/2+k, 'y1': one_ball_center_y+bdia/2, 'fillcolor': 'white', 'line': dict(color="crimson", width=1)} for k in range(5)],
                # go.layout.Shape(type="circle",xref="x",yref="y",x0=one_ball_center_x-bdia/2+3,y0=one_ball_center_y-bdia/2,x1=one_ball_center_x+bdia/2+3,y1=one_ball_center_y+bdia/2, fillcolor="white", line_color="crimson"),
            ],
            # 'add_shape': [
